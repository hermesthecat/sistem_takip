...
VALUES ('İstanbul'),
    ...
    ('Antalya');
-- Örnek projeler
INSERT IGNORE INTO projeler (proje_adi, proje_kodu, aciklama, durum)
VALUES (
        'Web Hosting',
        'WH-2024',
...
-- Örnek hizmetler
INSERT IGNORE INTO hizmetler (hizmet_adi, aciklama, port)
VALUES ('HTTP Web Sunucu', 'Web sunucu hizmeti', '80'),
    (
        'HTTPS Web Sunucu',
